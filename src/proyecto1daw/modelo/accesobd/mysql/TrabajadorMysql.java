 ...
 * @author Jaime
 */
public class TrabajadorMysql extends TrabajadorDAO {
    ...
    public void actualizarCampo(String tabla,String dni, String campo, String nuevoValor) throws SQLException{
        Conexion c = new Conexion();
        Connection accesoBD = c.getConexion();
